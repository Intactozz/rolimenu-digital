...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-wTOwFbmY.js
var server_wTOwFbmY_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-7heh5zpM.mjs");
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_wTOwFbmY_exports as t };
